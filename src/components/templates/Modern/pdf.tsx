...
const styles = StyleSheet.create({
  ...
  headerBox: { backgroundColor: '#EFF6FF', padding: 15, marginBottom: 20, borderRadius: 4 },
  header: { fontSize: 24, marginBottom: 5, fontWeight: 'bold', color: '#1E3A8A' },
  subHeader: { fontSize: 11, color: '#1D4ED8', marginBottom: 10 },
  summary: { fontSize: 10, lineHeight: 1.6, color: '#333' },
  sectionTitle: { fontSize: 14, fontWeight: 'bold', color: '#1E3A8A', borderLeft: '4pt solid #3B82F6', paddingLeft: 8, marginBottom: 10, marginTop: 15 },
  experienceItem: { marginBottom: 12, paddingLeft: 8 },
  ...
  educationItem: { marginBottom: 8, paddingLeft: 8 },
  row: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  skills: { fontSize: 10, lineHeight: 1.6, paddingLeft: 8 }
});
